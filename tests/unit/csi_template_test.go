	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				expectedImages: []string{
					"rancher/mirrored-sig-storage-csi-node-driver-registrar:v2.9.0",
					"rancher/mirrored-cloud-provider-vsphere-csi-release-driver:v3.1.0",
					"rancher/mirrored-sig-storage-livenessprobe:v2.11.0",
				},
			},
		},
		{
		...
		},
		{
			...
			args: args{
				...
				expectedImages: []string{
					...
					"rancher/mirrored-cloud-provider-vsphere-csi-release-driver:v2.7.2",
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				expectedImages: []string{
					"rancher/mirrored-sig-storage-csi-attacher:v4.4.0",
					"rancher/mirrored-sig-storage-csi-resizer:v1.9.0",
					"rancher/mirrored-cloud-provider-vsphere-csi-release-driver:v3.1.0",
					"rancher/mirrored-sig-storage-livenessprobe:v2.11.0",
					"rancher/mirrored-cloud-provider-vsphere-csi-release-syncer:v3.1.0",
					"rancher/mirrored-sig-storage-csi-provisioner:v3.6.0",
				},
			},
		},
		{
		...
		},
		{
			...
			args: args{
				...
				expectedImages: []string{
					...
					"rancher/mirrored-cloud-provider-vsphere-csi-release-driver:v2.7.2",
					"rancher/mirrored-sig-storage-livenessprobe:v2.8.0",
					"rancher/mirrored-cloud-provider-vsphere-csi-release-syncer:v2.7.2",
