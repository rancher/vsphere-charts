	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				releaseName:   "cpitest-" + strings.ToLower(random.UniqueId()),
				chartRelPath:  cpiChart,
				expectedImage: "rancher/mirrored-cloud-provider-vsphere-cpi-release-manager:v1.26.2",
			},
		},
		{
			...
			args: args{
				...
				releaseName:   "cpitest-" + strings.ToLower(random.UniqueId()),
				chartRelPath:  cpiChart,
				expectedImage: "rancher/mirrored-cloud-provider-vsphere-cpi-release-manager:v1.25.3",
			},
		},
		{
			...
			args: args{
				...
				releaseName:   "cpitest-" + strings.ToLower(random.UniqueId()),
				chartRelPath:  cpiChart,
				expectedImage: "rancher/mirrored-cloud-provider-vsphere-cpi-release-manager:v1.24.6",
			},
		},
		{
